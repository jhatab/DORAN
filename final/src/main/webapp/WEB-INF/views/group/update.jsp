...
<link rel="stylesheet" type="text/css" href="/css/groupUpdate.css">
	...
	<div class="groupUpdate_wrap">
		...
		<select name="categoryId">
			...
			<c:forEach items="${categoryList}" var="cList">
				<option value="${cList.categoryId}" <c:if test="${cList.categoryId == groupInfo.categoryId}">checked</c:if>>${cList.categoryName}</option>
			</c:forEach>
		</select>
