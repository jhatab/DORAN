	...
	<div class="subnav">
		<div class="tab">
			...
			<div class="group_more">
				<button class="group_btn" type="button"
					onclick="location.href='/group/list'">더보기</button>
			</div>
				...
				<div class="panelList">
					<c:forEach items="${postList}" var="pList" begin="1" step="2">
						<div class="panel category${pList.categoryId}"
							onclick="location.href='/group/home?groupId=${pList.groupId}#post${pList.postId}'"
							style="width: 416px;">
							...
							<div class="content_list">
								...
								<div class="like_view">
									<img alt="like" src="/images/like.png"> <span>${pList.likeCount}</span>
								</div>
